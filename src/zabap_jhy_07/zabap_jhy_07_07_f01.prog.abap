...
*   옵션 재설정 : 제목, 열넓이 최적화
    ...
    gs_layout-grid_title = gs_display-carrid && ' 항공사의 항공편 정보'(t01).
    gs_layout-cwidth_opt = abap_on.
...
* Handler Table에 Event를 위한 Method 등록
  SET HANDLER go_event_handler->on_double_click FOR go_alv_grid.    " 특정 객체만
* SET HANDLER go_event_handler->on_double_click FOR ALL INSTANCES.  " 모든 객체
